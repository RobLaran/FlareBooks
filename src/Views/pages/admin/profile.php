<div class="profile-page">
    <div class="profile-container">
        <form action="<?= routeTo("/admin/profile/" . $info['id']) ?>" method="POST" class="profile-card">
        ...
        <div class="password-change-section">
            ...
            <form action="<?= routeTo("/admin/profile/change-password/" . $info['id']) ?>" method="POST" class="password-form-grid">
                <div class="info-row input-container">
