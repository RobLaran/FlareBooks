	...
	<div class="table-container">
        ...
        <div class="row two">
            ...
            <div class="search-input-container">
				...
				<input type="text" id="search-input" name="search" data-route="<?= routeTo('/admin/books/search-books') ?>" onkeyup="booksTable.search(this, this.value)">
            </div>
        ...
        actions: (row) => {
            return `
                <div class="action-buttons">
                    <a href="<?= routeTo("/admin/books/edit/") ?>${row['ISBN']}" class="button act-edit safe">
                        <img src="<?= getFile("public/img/edit.png") ?>">
                    </a>
                    <form class="delete-book-form" action="<?= routeTo('/admin/books/delete/') ?>${row["ISBN"]}" method="POST">
